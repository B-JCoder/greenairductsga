        ...
        <div className="text-center mt-24">
          <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-10 rounded-3xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl md:text-4xl font-extrabold mb-4">Ready to Breathe Cleaner Air?</h3>
              <p className="text-lg md:text-xl mb-6">Call now for your free estimate and same-day service!</p>
